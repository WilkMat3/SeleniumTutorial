...
namespace Framework
{
    public class FW
    {
        ...
        public static FwConfig Config => _configuration ?? throw new NullReferenceException(" Config not set");
        ...
        public static Logger Log => _logger ?? throw new NullReferenceException("Logger is null set it first");
             [ThreadStatic]
